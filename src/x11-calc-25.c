...
void v_init_keypad(obutton *h_button[], oswitch *h_switch[]) {
   ...
   h_button[0] = h_button_create(00263, ' ', "SST", "FIX", "", h_normal_font, h_small_font, h_alternate_font, KEYBOARD_COL_A, KEYBOARD_ROW_1, SMALL_KEY_WIDTH, KEY_HEIGHT, False, BLACK, YELLOW, BLUE);
   h_button[1] = h_button_create(00262, 000, "BST", "SCI", "", h_normal_font, h_small_font, h_alternate_font, KEYBOARD_COL_B, KEYBOARD_ROW_1, SMALL_KEY_WIDTH, KEY_HEIGHT, False, BLACK, YELLOW, BLUE);
   h_button[2] = h_button_create(00261, 000, "GTO", "ENG", "", h_normal_font, h_small_font, h_alternate_font, KEYBOARD_COL_C, KEYBOARD_ROW_1, SMALL_KEY_WIDTH, KEY_HEIGHT, False, BLACK, YELLOW, BLUE);
   ...
   h_button[6] = h_button_create(00102, 000, "R", "s", "1/x", h_normal_font, h_small_font, h_alternate_font, KEYBOARD_COL_B, KEYBOARD_ROW_2, SMALL_KEY_WIDTH, KEY_HEIGHT, False, BLACK, YELLOW, BLUE);
   h_button[7] = h_button_create(00101, 000, "STO", "", "", h_normal_font, h_small_font, h_alternate_font, KEYBOARD_COL_C, KEYBOARD_ROW_2, SMALL_KEY_WIDTH, KEY_HEIGHT, False, BLACK, YELLOW, BLUE);
   h_button[8] = h_button_create(00100, 000, "RCL", "", "", h_normal_font, h_small_font, h_alternate_font, KEYBOARD_COL_D, KEYBOARD_ROW_2, SMALL_KEY_WIDTH, KEY_HEIGHT, False, BLACK, YELLOW, BLUE);
   h_button[9] = h_button_create(00104, 000, "E+", "E-", "", h_normal_font, h_small_font, h_alternate_font, KEYBOARD_COL_E, KEYBOARD_ROW_2, SMALL_KEY_WIDTH, KEY_HEIGHT, False, BLACK, YELLOW, BLUE);
   ...
   h_button[13] = h_button_create(00324, 033, "CLX", "STK", "GRD", h_normal_font, h_small_font, h_alternate_font, KEYBOARD_COL_E, KEYBOARD_ROW_3, SMALL_KEY_WIDTH, KEY_HEIGHT, False, BLACK, YELLOW, BLUE);

   /* Define fourth row of keys. */
   h_button[14] = h_button_create(00143, '-', "-", "X<Y", "X<0", h_large_font, h_small_font, h_alternate_font, KEYBOARD_COL_1, KEYBOARD_ROW_4, SMALL_KEY_WIDTH, KEY_HEIGHT, False, BEIGE, YELLOW, BLUE);
   ...
   h_button[18] = h_button_create(00243, '+', "+", "X\x1b\x59", "X\x1b\x30", h_large_font, h_small_font, h_alternate_font, KEYBOARD_COL_1, KEYBOARD_ROW_5, SMALL_KEY_WIDTH, KEY_HEIGHT, False, BEIGE, YELLOW, BLUE);
   ...
   h_button[29] = h_button_create(00220, 000, "R/S", "PAUSE", "NOP", h_normal_font, h_small_font, h_alternate_font, KEYBOARD_COL_4, KEYBOARD_ROW_7, NUM_KEY_WIDTH, KEY_HEIGHT, False, BEIGE, YELLOW, BLUE);
}

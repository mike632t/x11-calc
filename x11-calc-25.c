...
void v_init_keypad(obutton *h_button[]){
   ...
   h_button[0] = h_button_create(00000, 000, "SST", "FIX", "", h_normal_font, h_small_font, h_alternate_font, 12, 85, 33, 30, False, BLACK);
   h_button[1] = h_button_create(00000, 000, "BST", "SCI", "", h_normal_font, h_small_font, h_alternate_font, 48, 85, 33, 30, False, BLACK);
   h_button[2] = h_button_create(00000, 000, "GTO", "ENG", "", h_normal_font, h_small_font, h_alternate_font, 84, 85, 33, 30, False, BLACK);
   ...
   h_button[6] = h_button_create(00000, 000, "R", "s", "1/x", h_normal_font, h_small_font, h_alternate_font, 48, 128, 33, 30, False, BLACK);
   h_button[7] = h_button_create(00000, 000, "STO", "", "", h_normal_font, h_small_font, h_alternate_font, 84, 128, 33, 30, False, BLACK);
   h_button[8] = h_button_create(00000, 000, "RCL", "", "", h_normal_font, h_small_font, h_alternate_font, 120, 128, 33, 30, False, BLACK);
   h_button[9] = h_button_create(00000, 000, "E+", "E-", "", h_normal_font, h_small_font, h_alternate_font, 156, 128, 33, 30, False, BLACK); 
   ...
   h_button[13] = h_button_create(00000, 033, "CLX", "STK", "GRD", h_normal_font, h_small_font, h_alternate_font, 156, 171, 33, 30, False, BLACK);

   /* Define fourth row of keys. */
   h_button[14] = h_button_create(00000, '-', "-", "X<Y", "X<0", h_large_font, h_small_font, h_alternate_font, 12, 214, 33, 30, False, BEIGE);
   ...
   h_button[18] = h_button_create(00000, '+', "+", "X\x1b\x59", "X\x1b\x30", h_large_font, h_small_font, h_alternate_font, 12, 257, 33, 30, False, BEIGE);
   ...
   h_button[29] = h_button_create(00000, 000, "R/S", "PAUSE", "NOP", h_normal_font, h_small_font, h_alternate_font, 148, 343, 41, 30, False, BEIGE);
}
